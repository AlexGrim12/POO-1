...
public class GameOfLife extends JFrame implements ActionListener{
        ...
        if (ae.getSource().equals(mi_file_exit)) {
            ...
            try {
               desktop.browse(new URI("https://www.youtube.com/watch?v=OWXD_wJxCKQ"));
                ...
                JOptionPane.showMessageDialog(null, "Conway's game of life was a cellular animation devised by the mathematician John Conway", "Source", JOptionPane.INFORMATION_MESSAGE);
            }
        }
      }
  ...
  private class GameBoard extends JPanel implements ComponentListener, MouseListener, MouseMotionListener, Runnable{
    ...
    public void paintComponent(Graphics g){
      ...
      for(int i=0; i<= d_gameBoardSize.width; i++){
        g.drawLine(((i*BLOCK_SIZE)+BLOCK_SIZE), BLOCK_SIZE, (i*BLOCK_SIZE)+BLOCK_SIZE, (BLOCK_SIZE*d_gameBoardSize.height));
      }
